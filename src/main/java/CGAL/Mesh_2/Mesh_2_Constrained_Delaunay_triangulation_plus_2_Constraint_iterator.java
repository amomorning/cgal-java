...
public class Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_iterator implements   Iterable<Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id>, Iterator<Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id>  {
  ...
  public synchronized void delete() {
    ...
    public Iterator<Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id> iterator() {
      return this;
    }
    
    //we store an object of type Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id to avoid
    //creation and allocation of a java object at each iteration.
    private Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id objectInstance = new Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id();
    public Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id next() {
      next(objectInstance);
  ...
  public Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id slow_next() {
    return new Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id(CGAL_Mesh_2JNI.Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_iterator_slow_next(swigCPtr, this), true);
  }

  public void next(Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id r) {
    CGAL_Mesh_2JNI.Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_iterator_next(swigCPtr, this, Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id.getCPtr(r), r);
  }
