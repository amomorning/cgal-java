...
public class Mesh_2_Constrained_Delaunay_triangulation_plus_2 extends Internal_Constrained_Delaunay_triangulation_2_Mesh_2_Constrained_Delaunay_triangulation_plus_2 {
  ...
  public void remove_constraint(Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id c) {
    CGAL_Mesh_2JNI.Mesh_2_Constrained_Delaunay_triangulation_plus_2_remove_constraint(swigCPtr, this, Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id.getCPtr(c), c);
  }
  ...
  public Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id insert_constraint(Polygon_2 p) {
    return new Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id(CGAL_Mesh_2JNI.Mesh_2_Constrained_Delaunay_triangulation_plus_2_insert_constraint__SWIG_0(swigCPtr, this, Polygon_2.getCPtr(p), p), true);
  }

  public Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id insert_constraint(Iterator<Point_2> input, boolean closed) {
    return new Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id(CGAL_Mesh_2JNI.Mesh_2_Constrained_Delaunay_triangulation_plus_2_insert_constraint__SWIG_1(swigCPtr, this, input, closed), true);
  }

  public Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id insert_constraint(Iterator<Point_2> input) {
    return new Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id(CGAL_Mesh_2JNI.Mesh_2_Constrained_Delaunay_triangulation_plus_2_insert_constraint__SWIG_2(swigCPtr, this, input), true);
  }

  public Mesh_2_Constrained_Delaunay_triangulation_plus_2_Vertices_in_constraint_iterator vertices_in_constraint(Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id cid) {
    return new Mesh_2_Constrained_Delaunay_triangulation_plus_2_Vertices_in_constraint_iterator(CGAL_Mesh_2JNI.Mesh_2_Constrained_Delaunay_triangulation_plus_2_vertices_in_constraint(swigCPtr, this, Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id.getCPtr(cid), cid), true);
  }

  public int remove_points_without_corresponding_vertex(Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id cid) {
    return CGAL_Mesh_2JNI.Mesh_2_Constrained_Delaunay_triangulation_plus_2_remove_points_without_corresponding_vertex(swigCPtr, this, Mesh_2_Constrained_Delaunay_triangulation_plus_2_Constraint_id.getCPtr(cid), cid);
  }
