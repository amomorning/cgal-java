...
public class Delaunay_triangulation_2 extends Internal_Triangulation_2_Delaunay_triangulation_2 {
  ...
  public Delaunay_triangulation_2_Vertex_handle move_if_no_collision(Delaunay_triangulation_2_Vertex_handle c1, Point_2 c2) {
    return new Delaunay_triangulation_2_Vertex_handle(CGAL_Triangulation_2JNI.Delaunay_triangulation_2_move_if_no_collision__SWIG_0(swigCPtr, this, Delaunay_triangulation_2_Vertex_handle.getCPtr(c1), c1, Point_2.getCPtr(c2), c2), true);
  }

  public void move_if_no_collision(Delaunay_triangulation_2_Vertex_handle c1, Point_2 c2, Delaunay_triangulation_2_Vertex_handle ret) {
    CGAL_Triangulation_2JNI.Delaunay_triangulation_2_move_if_no_collision__SWIG_1(swigCPtr, this, Delaunay_triangulation_2_Vertex_handle.getCPtr(c1), c1, Point_2.getCPtr(c2), c2, Delaunay_triangulation_2_Vertex_handle.getCPtr(ret), ret);
  }

  public Delaunay_triangulation_2_Vertex_handle move(Delaunay_triangulation_2_Vertex_handle c1, Point_2 c2) {
    return new Delaunay_triangulation_2_Vertex_handle(CGAL_Triangulation_2JNI.Delaunay_triangulation_2_move__SWIG_0(swigCPtr, this, Delaunay_triangulation_2_Vertex_handle.getCPtr(c1), c1, Point_2.getCPtr(c2), c2), true);
  }

  public void move(Delaunay_triangulation_2_Vertex_handle c1, Point_2 c2, Delaunay_triangulation_2_Vertex_handle ret) {
    CGAL_Triangulation_2JNI.Delaunay_triangulation_2_move__SWIG_1(swigCPtr, this, Delaunay_triangulation_2_Vertex_handle.getCPtr(c1), c1, Point_2.getCPtr(c2), c2, Delaunay_triangulation_2_Vertex_handle.getCPtr(ret), ret);
  }
