...
public class Constrained_Delaunay_triangulation_plus_2 extends Internal_Constrained_Delaunay_triangulation_2_Constrained_Delaunay_triangulation_plus_2 {
  ...
  public void remove_constraint(Constrained_Delaunay_triangulation_plus_2_Constraint_id c) {
    CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_remove_constraint(swigCPtr, this, Constrained_Delaunay_triangulation_plus_2_Constraint_id.getCPtr(c), c);
  }
  ...
  public Constrained_Delaunay_triangulation_plus_2_Vertices_in_constraint_iterator vertices_in_constraint(Constrained_Delaunay_triangulation_plus_2_Constraint_id cid) {
    return new Constrained_Delaunay_triangulation_plus_2_Vertices_in_constraint_iterator(CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_vertices_in_constraint(swigCPtr, this, Constrained_Delaunay_triangulation_plus_2_Constraint_id.getCPtr(cid), cid), true);
  }
